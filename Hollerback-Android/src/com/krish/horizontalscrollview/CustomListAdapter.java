...
public class CustomListAdapter extends ArrayAdapter<VideoModel> {
    ...
    public CustomListAdapter(Context context, ImageFetcher imageFetcher, ArrayList<VideoModel> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = (RelativeLayout) View.inflate(context, R.layout.video_gallery_item, null);
