...
public class ContactChipsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.contact_chips, parent, false);
            holder.nameTextView = (TextView) convertView.findViewById(R.id.tv_chips_name);
            holder.parentView = (RelativeLayout) convertView.findViewById(R.id.rl_chips_layout);
