...
public class ContactsListAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.row_invitecontactresults, parent,
					false);
			holder.name = (TextView) convertView
					.findViewById(R.id.lazyTitle);
			holder.phone = (TextView) convertView
					.findViewById(R.id.lazySubTitle);
			holder.profileImage = (ImageView) convertView
					.findViewById(R.id.lazyIcon);
			holder.stateImage = (ImageView) convertView
					.findViewById(R.id.lazyContactType);
			holder.chkSelected = (CheckBox) convertView
					.findViewById(R.id.chkSelected); 
			holder.wrapperContact = (ViewGroup)convertView
					.findViewById(R.id.wrapperContact); 
		...
		final UserModel user = TempMemoryStore.users.mUserModelHash.get(contactitems
				.get(realposition));
