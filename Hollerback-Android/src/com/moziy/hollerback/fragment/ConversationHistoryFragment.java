...
public class ConversationHistoryFragment extends BaseFragment {
     ...
     * argument.
     */
    public static ConversationHistoryFragment newInstance(ConversationModel conversation) {

        ConversationHistoryFragment f = new ConversationHistoryFragment();
     ...
     * argument.
     */
    public static ConversationHistoryFragment newInstance(long conversation_id, boolean startRecording) {
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (IABIntent.isIntent(intent, IABIntent.UPLOAD_VIDEO_UPDATE)) {
                ...
                ConversationHistoryFragment.this.stopLoading();
            }
        }
    };
