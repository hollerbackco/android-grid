...
public class OldContactsFragment extends BaseFragment implements TaskClient {
    ...
    private static final String TAG = OldContactsFragment.class.getSimpleName();
    public static final String FRAGMENT_TAG = OldContactsFragment.class.getSimpleName();
    ...
    public static OldContactsFragment newInstance() {
        OldContactsFragment f = new OldContactsFragment();
        return f;
    }

    public static OldContactsFragment newInstance(boolean isWelcomeScreen, String fileDataName) {
        OldContactsFragment f = new OldContactsFragment();
        ...
        mListener = new OnContactSelectedListener() {
            ...
            public void onItemClicked(int position) {
                ...
                if (names.length > 0) {
                    ...
                    OldContactsFragment.this.getSherlockActivity().getSupportActionBar().setTitle(mConversationTitle);

                } else {
                    OldContactsFragment.this.getSherlockActivity().getSupportActionBar().setTitle(mActivity.getResources().getString(R.string.preference_friends));
                }
            }
    ...
    protected void bindData() {
        ...
        HBRequestManager.getContacts(TempMemoryStore.users.array, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusId, JSONObject response) {
                ...
                OldContactsFragment.this.stopLoading();
