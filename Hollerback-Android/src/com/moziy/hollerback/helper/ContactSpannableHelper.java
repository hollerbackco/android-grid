...
public class ContactSpannableHelper {
    ...
    public void addContactName(EditText editText, Context context, String name, String phoneNumber) {
        View parent = LayoutInflater.from(context).inflate(R.layout.contact_item_chip, null);
        ...
        editText.getEditableText().insert(editText.getSelectionStart(), addNameDrawable(dd, phoneNumber));
    }
    ...
    public SpannableStringBuilder addNameDrawable(Drawable dd, String phone) {
        ...
        builder.append(HollerbackConstants.PHONE_PRE + phone + HollerbackConstants.PHONE_SUF);
        builder.setSpan(new ImageSpan(dd), builder.length() - (HollerbackConstants.PHONE_PRE + phone + HollerbackConstants.PHONE_SUF).length(), builder.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
