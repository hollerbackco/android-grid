...
public class UploadTask {
    ...
    private void showUploadingNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(mContext, 0, new Intent(mContext, NotifyingController.class), 0);

        Notification notification = new NotificationCompat.Builder(mContext).setContentTitle(title).setContentText(desc).setOngoing(true).setSmallIcon(android.R.drawable.stat_sys_upload)
    ...
    private void showFinishUploadingNotification() {
        ...
        Notification notification = new NotificationCompat.Builder(mContext).setContentTitle(title).setContentText(desc).setOngoing(false).setSmallIcon(android.R.drawable.stat_sys_upload_done)
                .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.drawable.icon)).build();
