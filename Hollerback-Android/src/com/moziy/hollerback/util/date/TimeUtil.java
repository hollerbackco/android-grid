...
public class TimeUtil {
    ...
    public static final SimpleDateFormat LOCAL_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZZZZZ", Locale.US); // used for displaying in client
    ...
    static {
        SERVER_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZZZZZ", Locale.US);
