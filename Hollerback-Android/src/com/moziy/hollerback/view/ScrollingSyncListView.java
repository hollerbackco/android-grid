...
public class ScrollingSyncListView extends ListView
{
	private SparseIntArray mScrollingSiblings = new SparseIntArray();
	
	
	public ScrollingSyncListView(Context context)
	{
		this(context, null);
	}
	
	public ScrollingSyncListView(Context context, AttributeSet attrs)
	{
		this(context, attrs, android.R.attr.listViewStyle);
	}
	
	public ScrollingSyncListView(Context context, AttributeSet attrs, int defStyle)
	{
