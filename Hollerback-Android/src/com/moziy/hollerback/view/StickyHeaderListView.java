...
public class StickyHeaderListView extends FrameLayout implements OnScrollListener {
    ...
    public void setHeaderSeparator(int color, int width) {
        ...
        ViewGroup.LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, width, Gravity.TOP);
        ...
        if (mAdapter != null && mIndexer != null && mDoHeaderReset) {
            ...
            if (sectionPos != mCurrentSectionPos) {
                ...
                if (sectionPos == -1) {
                    ...
                    v.measure(MeasureSpec.makeMeasureSpec(mListView.getWidth(), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(mListView.getHeight(), MeasureSpec.AT_MOST));
                    this.removeView(mStickyHeader);
                    mStickyHeader = v;
                    newView = true;
                }
            ...
            if (mStickyHeader != null) {
                ...
                if (newView) {
                    ...
                    if (mSeparatorView != null && !mStickyHeader.equals(mDummyHeader)) {
                        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, mSeparatorWidth);
    ...
    private void setChildViews() {
        ...
        ViewGroup.LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, 1, Gravity.TOP);
